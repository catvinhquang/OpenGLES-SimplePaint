...
public class Brush {
    ...
    public Brush(int shaderProgramId, Bitmap candy, Bitmap highlight) {
        ...
        textureId = Utils.makeTexture(candy, BRUSH_PIXEL_SIZE, BRUSH_PIXEL_SIZE);

        glDeleteTextures(1, new int[]{maskId}, 0);
        maskId = Utils.makeTexture(candy, BRUSH_PIXEL_SIZE, BRUSH_PIXEL_SIZE);
    }
     ...
     */
    public void drawQueue(Queue<Point> dabs) {
